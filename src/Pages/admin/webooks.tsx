        ...
        <div className="bg-white shadow rounded-lg overflow-hidden">
          {webhooks.length === 0 ? (
            <div className="p-8 text-center">
              ...
              <h3 className="mt-2 text-lg font-medium text-gray-900">No webhooks configured</h3>
                  ...
                  {webhooks.map((webhook) => (
                    <tr key={webhook.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        {webhook.webhookId && (
                          <div className="text-xs text-gray-500">ID: {webhook.webhookId}</div>
                        )}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <div className="flex items-center">
                          <LinkIcon className="h-4 w-4 text-blue-500 mr-1" />
                          <span className="truncate max-w-xs">{webhook.targetUrl}</span>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
